    ...
    <body onload="time()">
        ...
        <section id="container" >
                ...
                <div id="sidebar"  class="nav-collapse ">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="bh20/bh20_home.jsp" style="color: white">BH-20</a></li>
            ...
            *********************************************************************************************************************************************************** -->
                            ...
                            <div id="external-events">
                                <form class="form-horizontal style-form" action="InsertSate.jsp" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="assunto" placeholder=" " maxlength="200" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-sm-3 control-label">Hora</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="hora" placeholder=" " maxlength="30" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-sm-3 control-label">Dia</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="dia" placeholder=" " maxlength="30" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
            ...
            <script src="assets3/js/calendar_comando.js" type="text/javascript"></script>
        </section>
    </body>
</html>
