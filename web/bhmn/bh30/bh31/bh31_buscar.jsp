                    ...
                    <div class="col-lg-6">
                        <div class="form-panel">
                            <form class="form-horizontal style-form" action="BuscarPessoal.jsp" method="post">                                
                                <h5 class="centered"><i class="fa fa-angle-double-right"></i><b> Digite o Nome de Guerra</b></h5>
                                <br><br>
                                <div class="form-group">
                                    <label class="col-md-4 col-md-4 control-label" style="text-align: right;" ><font color="black"><b>Nome Guerra:</b></font></label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="nome" name="nome">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-theme center-block">Buscar por Nome</button>
                            </form>
                        </div>
                    </div>  
                    <div class="col-lg-6">
                        <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form" action="BuscarPessoal.jsp" method="post">
                                <h5 class="centered"><i class="fa fa-angle-double-right"></i><b> Digite o NIP</b></h5>
                                <br><br>
                                <div class="form-group">                                    
                                    <label class="col-md-4 col-md-4 control-label" style="text-align: right;"><font color="black"><b>NIP:</b></font></label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="nip" name="nip">
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-theme center-block">Buscar por NIP</button>
                            </form>
                        </div>
                    </div> 
                </section>
