...
<%Pessoal_model servidor = (Pessoal_model) request.getAttribute("ttc");
    ...
    ArrayList<Pessoal_movi> servidorarray = (ArrayList<Pessoal_movi>) request.getAttribute("ttcarray");
                ...
                <section class="wrapper">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <form  class="col-sm-2 control-label" action="SargenteanteExibePessoal.jsp" method="post">
                                <input type="hidden" class="form-control" id="nip" name="nip" value="<%out.print(servidor.getNip());%>">
                                <input type="hidden" class="form-control" id="type" name="type" value="23">
                            ...
                            <form class="col-sm-2 control-label" action="SargenteanteListarFerias.jsp" method="post">
                                ...
                                <input type="hidden" class="form-control" name="typeServ" value="3">
