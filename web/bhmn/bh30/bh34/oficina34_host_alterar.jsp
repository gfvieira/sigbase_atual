                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" size="1" name="setor" required>
                                                <option value="<%out.print(hostip.getSetor());%>"><%out.print(hostip.getSetor());%></option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" size="1" name="type" >
                                                <option value="<%out.print(hostip.getTipo());%>"><%out.print(hostip.getTipo());%></option>
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" size="1" name="so" >
                                                <option value="<%out.print(hostip.getSo());%>"><%out.print(hostip.getSo());%></option>
