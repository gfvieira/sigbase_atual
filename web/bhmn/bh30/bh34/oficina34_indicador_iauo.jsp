                                ...
                                <div class="custom-bar-chart">
                                    ...
                                    <div class="bar" style="width: 6%; margin: 0px 4%; margin-left: 50px;">
                                        ...
                                        <div class="bar" style="width: 6%; margin: 0px 4%;">
                                            <%}
                                                if (sate.getTotalFechado() / (sate.getTotal()) >= 0.90) {%>
                                            <div class="title" style="color: black; font-size: 14px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></div>
                                            <div class="value tooltips" data-original-title="<%out.print(df.format(sate.getTotalFechado() / (sate.getTotal()) * 100));%>" data-toggle="tooltip" data-placement="top" style="background: #006400"><%out.print(sate.getTotalFechado() / (sate.getTotal()) * 100);%>%</div>
                                            <%} else {%>
                                            <div class="title" style="color: black; font-size: 14px;"><%out.print(mesInd);%>/<%out.print(sate.getAno());%></div>
                                            <div class="value tooltips" data-original-title="<%out.print(df.format(sate.getTotalFechado() / (sate.getTotal()) * 100));%>" data-toggle="tooltip" data-placement="top" style="background: #ff3333"><%out.print(sate.getTotalFechado() / (sate.getTotal()) * 100);%>%</div>
                                            <%}%>
                                        </div>
                                        <% }
                                            }%>
                                    ...
                                    <tbody>
                                        <tr>
                                            <%for (Indicador_model_anual sate : sateAnual) {
                                                    if (sate.getOficina().equals("OFICINAS")) {
                                                        if (sate.getTotalFechado() / (sate.getTotal()) >= 0.90) {%> 
                                            <td style="color: black; font-size: 14px;"><%out.print(df2.format(sate.getTotalFechado()));%>/<%out.print(df2.format(sate.getTotal()));%></td>
                                            <%} else if (sate.getTotal() == 0) {%>
