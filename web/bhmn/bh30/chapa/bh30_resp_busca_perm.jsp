                    ...
                    <div class="row">
                        <div class="col-md-12 mt">
                            <div class="content-panel">
                                <%if (perm == null) {%>
                                <h2 class="centered">Permissionário não encontrado!</h2>
                                <%} else {%>
                                <h2 class="centered"><%out.print("Permissionario encontrado!");%></h2>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>                                        
                                        <tr>
                                            <td class="col-sm-2"><%out.print(perm.getApto());%></td>
                                            <td class="col-sm-2"><%out.print(perm.getBloco());%></td>
                                            <td class="col-sm-4"><%out.print(perm.getNome());%></td>
                                            <td class="col-sm-2">                                                
                                                <form action="ExibePermissionario.jsp" method="post">      
                                                    ...
                                                    <input type="hidden" class="form-control" id="nip" name="nip" value="<% out.print(perm.getNip()); %>" >
                                            ...
                                            <td class="col-sm-2">
                                                <button title="Excluir Permissionários" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModal<%out.print(perm.getNip());%>"><i class="fa fa-trash-o"></i></button>
                                                <div class="modal fade" id="myModal<%out.print(perm.getNip());%>" role="dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form class="col-sm-2 control-label" action="RetiraPermissionario.jsp" method="post">
                                                                    <input type="hidden" id="nip" name="nip" value="<%out.print(perm.getNip());%>" > 
                                                                    <input type="hidden" id="apto" name="apto" value="<%out.print(perm.getApto());%>" > 
                                                                    <input type="hidden" id="bloco" name="bloco" value="<%out.print(perm.getBloco());%>" >
