...
<%ArrayList<Resposta_model> list = (ArrayList<Resposta_model>) request.getAttribute("resultado");
    String pergunta = (String) request.getAttribute("pergunta");
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <br> 
                    <br> 
                    <h2 class="intro-text text-center">Pergunta:</h2>
                    <br>
                    <p class="intro-text" align="center"><%out.print(pergunta);%></p>
                    <br> 
                    <br>                    
                    ...
                    <%for (Resposta_model result : list) {
                            total = (int) result.getTotal()+total;
                            totalSim = (int) result.getRespSim()+totalSim;
                            totalNa = (int) result.getRespNa()+totalNa;
                    ...
                    <table class="table table-hover">
                        <tbody>
                            <tr>
                                <th><i class="fa fa-angle-double-right text-center"></i>Geral:</th>
                                <th><i class="fa fa-angle-double-right text-center"></i>Total:</th>
                                <th><i class="fa fa-angle-double-right text-center"></i><%out.print(total);%></th>
                            </tr>
                            <tr>
                                <td><i class="center-block"></i>SIM</td>
                                <td><i class="center-block"></i>NÃO</td>
                            ...
                            <tr>
                                <td><i class="center-block"></i><%out.print(df.format((totalSim / total) * 100));%>%</td>
                                <td><i class="center-block"></i><%out.print(df.format(((total - (totalSim + totalNa)) / total) * 100));%>%</td>
                                <td><i class="center-block"></i><%out.print(df.format((totalNa / total) * 100));%>%</td>
                            </tr>
