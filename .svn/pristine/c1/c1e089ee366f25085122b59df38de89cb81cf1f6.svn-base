var Script = function () {
    ...
    $(function () {
      ...
      var tax_data = [
           {"period": "2011 Q3", "licensed": 3407, "sorned": 660, "teste": null},
           {"period": "2011 Q2", "licensed": 3351, "sorned": 629, "teste": null},
           {"period": "2011 Q1", "licensed": 3269, "sorned": 618, "teste": 4000},
      ...
      Morris.Line({
        ...
        data: tax_data,
        xkey: 'period',
        ykeys: ['licensed', 'sorned', 'teste'],
        labels: ['Licensed', 'Off the road', 'bh30'],
        lineColors:['#4ECDC4','#ed5565', '#378006']
      });
