                            ...
                            <div class="form-panel">
                                ...
                                <form class="form-horizontal style-form" action="AttUsuarioAdmin.jsp" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" id="nome" name="nome" value="<%out.print(user.getNome());%>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">NIP</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="nip" name="nip" value="<%out.print(user.getNip());%>" required>
                                        </div>
                                        <label class="col-sm-1 col-sm-2 control-label">Nome de Guerra</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="guerra" name="guerra"  value="<%out.print(user.getGuerra());%>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" size="1" name="grad">
                                                <option value="<%out.print(user.getPost());%>"><%out.print(user.getPost());%></option>
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="ramal" name="ramal" maxlength="4" value="<%out.print(user.getRamal());%>" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-3 control-label">Setor</label>
                                        <div class="col-sm-2">
                                            <select class="form-control" size="1" name="setor" disabled >
                                                <option value="<%out.print(user.getSetor());%>"><%out.print(user.getSetor());%></option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" size="1" id="grupo">
                                                <option value="">Selecione!</option>
                                                <option value="1">ADMIN</option>
                                                <option value="2">Total</option>
                                                <option value="3">Assesoria</option>
                                                <option value="4">Chefe Departamento</option>
                                                <option value="5">Encarregado</option>
                                                <option value="6">Sargenteante</option>
                                                <option value="7">BH-10</option>
                                                <option value="8">BH-20</option>
                                                <option value="9">BH-30</option>
                                                <option value="10">BH-40</option>
                                                <option value="11">BH-50</option>
                                            </select>
                                        </div> 
                                        <label class="col-sm-2 col-sm-2 control-label">Tipo de acesso</label>
                                        <div class="col-sm-3">
                                            <select class="form-control" size="1" id="type" name="type">
                                                <option value="<%out.print(user.getTypeAccess());%>"><%out.print(user.getTypeAccess());%></option>
                                            </select>
                                        </div> 
                                    </div>
                                    <div class="form-group">
