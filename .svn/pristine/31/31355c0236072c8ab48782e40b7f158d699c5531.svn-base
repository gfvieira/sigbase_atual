...
<%Pessoal_model servidor = (Pessoal_model) request.getAttribute("civil");
Pessoal_busca busca = (Pessoal_busca) request.getAttribute("busca");
    ArrayList<Pessoal_movi> servidorarray = (ArrayList<Pessoal_movi>) request.getAttribute("civilarray");
                ...
                <section class="wrapper">
                        ...
                        <div class="form-panel">
                            ...
                            <form class="form-horizontal style-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <p class="form-control-static" style="text-align: left;"><%out.print(servidor.getOs());%></p>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <form  class="col-sm-2 control-label" action="SargenteanteExibePessoal.jsp" method="post">
                                <input type="hidden" class="form-control" id="nip" name="nip" value="<%out.print(servidor.getNip());%>">
                                <input type="hidden" class="form-control" id="type" name="type" value="24">
                            ...
                            <form class="col-sm-2 control-label" action="SargenteanteListarFerias.jsp" method="post">
                                ...
                                <input type="hidden" class="form-control" name="typeServ" value="4">
