                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="label label-warning label-mini"><%out.print(sate.getStatus());%></span></td>
                                    <%} else if (sate.getStatus().equals("AGUARDANDO ENCARREGADO")) {%>
                                <td><span class="label label-info label-mini"><%out.print(sate.getStatus());%></span></td>
                                    <%} else {%>
