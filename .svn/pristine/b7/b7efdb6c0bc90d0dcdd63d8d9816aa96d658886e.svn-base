...
public class Exibe_indicador_30 extends HttpServlet {
                ...
                case "ica":
                    {
                        ...
                        for (int i = 1; i <= 6; i++) {
                            ...
                            if (mensal.equals("12") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("11") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(1);
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("10") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(1);
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("9") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(3);
                                tempanual.setTotalFechado(46);
                                tempanual.setOficina("ADESTRAMENTO");
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("8") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("7") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(1);
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("6") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(2);
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("5") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("4") && year.equals("15")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(0);
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("2") && year.equals("16")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(2);
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("3") && year.equals("16")) {
                                tempanual = new Indicador_model_anual();
                                ...
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                            } else if (mensal.equals("4") && year.equals("16")) {
                                tempanual = new Indicador_model_anual();
                                tempanual.setTotalAberto(2);
                                tempanual.setTotalFechado(53);
                                tempanual.setOficina("ADESTRAMENTO");
                                tempanual.setMes(mensal);
                                tempanual.setAno(year);
                                indicadorAnual.add(tempanual);
                ...
                case "casod":
                    {
                        ...
                        for (int i = 1; i <= 6; i++) {
                            ...
                            switch (mensal) {
                                ...
                                case "4":
                                    tempanual = new Indicador_model_anual();
                                    tempanual.setTotalAberto(107);
                                    tempanual.setTotalFechado(7);
                                    tempanual.setOficina("ODONTO");
                                    tempanual.setMes(mensal);
                                    tempanual.setAno(year);
                                    indicadorAnual.add(tempanual);
                ...
                case "iccv":
                    {
                        ...
                        for (int i = 1; i <= 6; i++) {
                            ...
                            switch (mensal) {
                                ...
                                case "4":
                                    tempanual = new Indicador_model_anual();
                                    tempanual.setTotalAberto(95);
                                    tempanual.setTotalFechado(25);
                                    tempanual.setOficina("VISITANTE");
                                    tempanual.setMes(mensal);
                                    tempanual.setAno(year);
                                    indicadorAnual.add(tempanual);
                ...
                case "iccm":
                    {
                        ...
                        for (int i = 1; i <= 6; i++) {
                            ...
                            switch (mensal) {
                                ...
                                case "4":
                                    tempanual = new Indicador_model_anual();
                                    tempanual.setTotalAberto(39);
                                    tempanual.setTotalFechado(18);
                                    tempanual.setOficina("MILITAR");
                                    tempanual.setMes(mensal);
                                    tempanual.setAno(year);
                                    indicadorAnual.add(tempanual);
