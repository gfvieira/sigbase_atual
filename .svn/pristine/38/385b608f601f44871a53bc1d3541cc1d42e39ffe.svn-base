...
public class DaoSargenteante {
    ...
    //================================================================================== BUSCA LISTA POR DEPARTAMENTO
    public ArrayList<Pessoal_model> buscaPracaDep(String access) {
        String selectTableSQL = "SELECT * from pessoal_praca where afast = '0' AND depto = '" + access + "' ORDER BY grad DESC";
    ...
    public ArrayList<Pessoal_model> buscaPracaDep(int grad, String access) {
        String selectTableSQL = "SELECT * from pessoal_praca where afast = '0' AND grad = '" + grad + "' AND depto = '" + access + "' ORDER BY grad DESC";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    public ArrayList<Pessoal_model> buscaOficialDep(String access) {
        String selectTableSQL = "SELECT * from pessoal_oficial where afast = '0' AND depto = '" + access + "' ORDER BY grad DESC";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    public ArrayList<Pessoal_model> buscaTTCDep(String access) {
        String selectTableSQL = "SELECT * from pessoal_ttc where afast = '0' AND depto = '" + access + "' ORDER BY grad DESC;";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    public ArrayList<Pessoal_model> buscaCivilDep(String access) {
        String selectTableSQL = "SELECT * from pessoal_civil where afast = '0' AND depto = '" + access + "' ORDER BY grad DESC";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    //================================================================================== BUSCA LISTA POR DEPARTAMENTO
    public ArrayList<Pessoal_model> buscaPracaDivisao(String access) {
        String selectTableSQL = "SELECT * from pessoal_praca where afast = '0' AND divisao = '" + access + "' ORDER BY grad DESC";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    public ArrayList<Pessoal_model> buscaPracaDivisao(int grad, String access) {
        String selectTableSQL = "SELECT * from pessoal_praca where afast = '0' AND grad = '" + grad + "' AND divisao = '" + access + "' ORDER BY grad DESC";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    public ArrayList<Pessoal_model> buscaOficialDivisao(String access) {
        String selectTableSQL = "SELECT * from pessoal_oficial where afast = '0' AND divisao = '" + access + "' ORDER BY grad DESC";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    public ArrayList<Pessoal_model> buscaTTCDivisao(String access) {
        String selectTableSQL = "SELECT * from pessoal_ttc where afast = '0' AND divisao = '" + access + "' ORDER BY grad DESC;";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
    ...
    public ArrayList<Pessoal_model> buscaCivilDivisao(String access) {
        String selectTableSQL = "SELECT * from pessoal_civil where afast = '0' AND divisao = '" + access + "' ORDER BY grad DESC";
        ArrayList<Pessoal_model> lista = new ArrayList<>();
   ...
   public ArrayList<Pessoal_movi> buscaMovi(Pessoal_model servidor, int type) {
    ...
    public Pessoal_busca planodebuscaCivil(String nip) {
        String selectTableSQL = "SELECT * from pessoal_civil_busca where nip_praca = '" + nip + "';";
        Pessoal_busca buscaRetorno = null;
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
