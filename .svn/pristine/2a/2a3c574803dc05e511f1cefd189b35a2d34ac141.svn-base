                        ...
                        <form  class="form login text-center" name="sigbase" action="AltSenha.jsp" method="POST">
                            <div class="row">
                                <div class="form-group col-lg-12" >
                                    ...
                                    <input class="form-control text-center" name="senha3" type="password" required placeholder="" autofocus>
                                </div>
                            </div>
                                <div class="row">
                                <div class="form-group col-lg-12" >
                                    <label>Senha Nova:</label>
                                    <input class="form-control text-center" name="senha1" type="password" required placeholder="" autofocus>
                            ...
                            <div class="row">
                                <div class="form-group col-lg-12" >
                                    ...
                                    <input class="form-control text-center" name="senha2" type="password" required placeholder="" autofocus>
                                </div>
                            </div>
                            <br>
                            <div class="row">
