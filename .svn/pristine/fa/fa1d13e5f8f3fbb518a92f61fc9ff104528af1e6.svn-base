...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="brand"><a href="/sigbase/index.html" style="margin-left: 0px; margin-right: 400px; margin-bottom: 0px"><img src="../css/img/logos/BHMN.png" class="" alt="" width="80"></a>
            SIG-BASE
            <a href="http://www.mar.mb" style="margin-left:400px; margin-right:0px; margin-bottom: 0px" ><img src="../css/img/mb.png" class="" alt="bhmn" width="80" ></a></div> 
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li>
                            <a class="page-scroll" href="home_telematica.html" style="color: black">Pedido de Serviço</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="telematica_consultar_pedido.html" style="color: black">Consultar Pedido</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="SateConsult.jsp?id=3" style="color: black">Listar Pedidos</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="#" style="color: black">Software</a>
                        </li>
                        <li>
                            <a class="page-scroll" href="telematica_documentacao.html" style="color: black">Documentação</a>
                        </li>
                    </ul>
                </div>
                <!-- /.navbar-collapse -->
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel center-block">
                                <h2 class="intro-text text-center"><b>SATE 2.0</b> - Serviço de Atendimento da Telemática<br><br></h2>
                    ...
                    <%}%>
                    <h3 class="intro-text text-center"><b>Detalhes da OS: </b><i><%out.print(sate.getOs());%></i></h3><br>
                    <h4 class="intro-text text-center"><b>Status: </b> <i><%out.print(sate.getStatus());%></i> </h4><br>
                            ...
                            <div class="form-panel">
                                <form class="form-horizontal style-form" action="">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getPost());%>-<%out.println(sate.getNome());%>" disabled>
                                        </div>
                                        <label class="col-sm-1 col-sm-2 control-label">NIP:</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getNip());%>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Ramal:</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getRamal());%>" disabled>
                                        </div>
                                        <label class="col-sm-1 col-sm-2 control-label">Setor:</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getSetor());%>" disabled>
                                        </div>                                            
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Atendimento:</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getAtendimento());%>" disabled>
                                        </div> 
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Equipamento:</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getEquipamento());%>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Solicitação:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getSolicitacao());%>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Descrição:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getDescricao());%>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Observação:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="nome" value="<%out.print(sate.getObs());%>" disabled>
                                        </div>
                                    </div>
                                </form>
                            </div>
