...
public class Util {
    ...
    protected static ArrayList<Pessoal_model> listarPessoal(int tipo) {
        ArrayList<Pessoal_model> servidorarray = new ArrayList<>();

        switch (tipo) {
            case 0:
                servidorarray = daobh30.buscaOficial();
                servidorarray.addAll(daobh30.buscaPraca());
            ...
            case 4:
                ...
                break;
            case 12:
                servidorarray = daobh30.buscaPraca(3);
                servidorarray.addAll(daobh30.buscaPraca(2));
                servidorarray.addAll(daobh30.buscaPraca(1));
                break;
            case 13:
                servidorarray = daobh30.buscaPraca(4);
                break;
            case 14:
                servidorarray = daobh30.buscaPraca(7);
                servidorarray.addAll(daobh30.buscaPraca(6));
                servidorarray.addAll(daobh30.buscaPraca(5));
                break;
            case 15:
                servidorarray = daobh30.buscaPraca(8);
                break;
            default:
                break;
        }
