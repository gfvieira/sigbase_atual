...
public class SateConsult extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            switch (id) {
                case 1: {
                    ...
                    satearray = daosate.buscaSate(id, nip);
                    ...
                    RequestDispatcher rd = req.getRequestDispatcher("telematica_resultado.jsp");
                ...
                case 2: {
                    daosate = new DaoOficina34();
                    satearray = new ArrayList<>();
                    satearray = daosate.buscaSate(id, os);
                    if (satearray.isEmpty() || satearray == null) {
                        Pedido_model sateRetorno = new Pedido_model();
                        sateRetorno.setOs("-");
                        sateRetorno.setNome("-");
                ...
                case 3: {
                    daosate = new DaoOficina34();
                    satearray = new ArrayList<>();
                    satearray = daosate.buscaSateAll();
                    if (satearray.isEmpty() || satearray == null) {
                        Pedido_model sateRetorno = new Pedido_model();
                        sateRetorno.setOs("-");
                        sateRetorno.setNome("-");
                    ...
                    req.setAttribute("satearray", satearray);
                    RequestDispatcher rd = req.getRequestDispatcher("telematica_resultado_all.jsp");
                    rd.forward(req, response);
                    break;
                }
                default:
