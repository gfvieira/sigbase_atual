...
public class InsertSate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp)
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            String da = new SimpleDateFormat("yyyy").format(tm);
            sate.setOs(Integer.toString(++param) + "/" + da);
            ...
            if (check == true) {
                sate.setMove("USUÁRIO || ABERTURA DO PEDIDO NO SISTEMA");
                sate.setIp(req.getRemoteAddr());
            ...
            if (check == false) {
                ...
                RequestDispatcher rd = req.getRequestDispatcher("oficina34_sate_os.jsp");
                rd.forward(req, resp);
            }
        }
    }
