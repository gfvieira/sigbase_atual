 ...
 * @author admin
 */
public class ListaCadPermissionario extends HttpServlet {

    private DaoChapa daochapa;
    private Chapa_model chapa;
    private ArrayList<Chapa_model> chapaarray;
    private String type = "";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //if (type.equals("index")) {
                ...
                RequestDispatcher rd = request.getRequestDispatcher("bh30_chapa_cadpermissionario.jsp");
