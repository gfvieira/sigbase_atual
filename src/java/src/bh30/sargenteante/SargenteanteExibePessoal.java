...
public class SargenteanteExibePessoal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DaoSargenteante daobh30 = new DaoSargenteante();
            ...
            switch (type) {
                case 1: {
                    ...
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_exibir_praca.jsp");
                ...
                case 2: {
                    ...
                    request.setAttribute("busca", busca);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_exibir_oficial.jsp");
                    rd.forward(request, response);
                    break;
                }
                case 3: {
                    ...
                    request.setAttribute("busca", busca);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_exibir_ttc.jsp");
                    rd.forward(request, response);
                    break;
                }
                case 4: {
                    ...
                    request.setAttribute("busca", busca);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_exibir_civil.jsp");
                    rd.forward(request, response);
                    break;
                }
                case 11: {
                    request.setAttribute("praca", servidor);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_att_praca.jsp");
                    rd.forward(request, response);
                    break;
                }
                case 12: {
                    request.setAttribute("oficial", servidor);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_att_oficial.jsp");
                    rd.forward(request, response);
                    break;
                }
                case 13: {
                    request.setAttribute("ttc", servidor);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_att_ttc.jsp");
                    rd.forward(request, response);
                    break;
                }
                case 14: {
                    request.setAttribute("civil", servidor);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_att_civil.jsp");
                    rd.forward(request, response);
                    break;
                }
                case 21:
                ...
                case 24: {
                    ...
                    request.setAttribute("busca", busca);
                    RequestDispatcher rd = request.getRequestDispatcher("sargenteante_att_busca.jsp");
                    rd.forward(request, response);
                    break;
                }
