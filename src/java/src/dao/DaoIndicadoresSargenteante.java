...
public class DaoIndicadoresSargenteante {

    private ConnectDataBase connectDataBase = null;
    private Error log = null;
    private Statement statement;

    public DaoIndicadoresSargenteante() {
    ...
    public Servidor_indicador buscaOfAll(String access) {
        String selectTableSQL = "select count(*) as total, "
                ...
                + "from pessoal_oficial where afast = '0' and divisao = '"+access+"'";
    ...
    public Servidor_indicador buscaPrAll(String access) {
        String selectTableSQL = "select count(*) as total, "
                ...
                + "from pessoal_praca where afast = '0' and divisao = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
    ...
    public Servidor_indicador buscaCvAll(String access) {
        String selectTableSQL = "select count(*) as total "
                + "from pessoal_civil where afast = '0' and divisao = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
    ...
    public Servidor_indicador buscaTtcAll(String access) {
        String selectTableSQL = "select count(*) as total "
                + "from pessoal_ttc where afast = '0' and divisao = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
    ...
    public Servidor_indicador buscaOfAllDep(String access) {
        String selectTableSQL = "select count(*) as total, "
                + "sum(case when grad = '15' then 1 else 0 end) as cmg, "
                + "sum(case when grad = '14' then 1 else 0 end) as cf, "
                + "sum(case when grad = '13' then 1 else 0 end) as cc, "
                ...
                + "sum(case when grad = '10' then 1 else 0 end) as t2, "
                + "sum(case when grad = '9' then 1 else 0 end) as gm "
                + "from pessoal_oficial where afast = '0' and depto = '"+access+"'";
                Servidor_indicador inc = new Servidor_indicador();
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
    ...
    public Servidor_indicador buscaPrAllDep(String access) {
        String selectTableSQL = "select count(*) as total, "
                + "sum(case when grad = '8' then 1 else 0 end) as so, "
                + "sum(case when grad = '7' then 1 else 0 end) as sg1, "
                + "sum(case when grad = '6' then 1 else 0 end) as sg2, "
                ...
                + "sum(case when grad = '2' then 1 else 0 end) as mn, "
                + "sum(case when grad = '1' then 1 else 0 end) as rc "
                + "from pessoal_praca where afast = '0' and depto = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
    ...
    public Servidor_indicador buscaCvAllDep(String access) {
        String selectTableSQL = "select count(*) as total "
                + "from pessoal_civil where afast = '0' and depto = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
    ...
    public Servidor_indicador buscaTtcAllDep(String access) {
        String selectTableSQL = "select count(*) as total "
                + "from pessoal_ttc where afast = '0' and depto = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
            if (connectDataBase.openConection() == null) {
                return null;//criar uma variavel no usauario pra condicao do banco
    ...
    public Servidor_indicador buscaOfAllDivisao(String access) {
        String selectTableSQL = "select count(*) as total, "
                + "sum(case when grad = '15' then 1 else 0 end) as cmg, "
                + "sum(case when grad = '14' then 1 else 0 end) as cf, "
                + "sum(case when grad = '13' then 1 else 0 end) as cc, "
    ...
    public Servidor_indicador buscaPrAllDivisao(String access) {
        String selectTableSQL = "select count(*) as total, "
                + "sum(case when grad = '8' then 1 else 0 end) as so, "
                + "sum(case when grad = '7' then 1 else 0 end) as sg1, "
                + "sum(case when grad = '6' then 1 else 0 end) as sg2, "
    ...
    public Servidor_indicador buscaCvAllDivisao(String access) {
        String selectTableSQL = "select count(*) as total "
                + "from pessoal_civil where afast = '0' and divisao = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
    ...
    public Servidor_indicador buscaTtcAllDivisao(String access) {
        String selectTableSQL = "select count(*) as total "
                + "from pessoal_ttc where afast = '0' and divisao = '"+access+"'";
                        Servidor_indicador inc = new Servidor_indicador();
        try {
