...
public class ContadorDiario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            diario1 = daopesquisa.diario(date, 1);
            diario2 = daopesquisa.diario(date, 2);
            diario3 = daopesquisa.diario(date, 3);
            ...
            RequestDispatcher rd = req.getRequestDispatcher("bh25_resultado_diario.jsp");
